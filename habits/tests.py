...
class HabitTestCase(APITestCase):
    """Тест для модели привычки"""

    def setUp(self):
        self.user1 = User.objects.create(email="test1@test.ru")
    ...
    def test_incorrect_data(self):
        """Тест создания некорректной привычки"""
    ...
    def test_incorrect_data_enjoyable(self):
        """Тест создания некорректной приятной привычки"""
        url = reverse("habits:create")
