...
from habits.services import create_periodic_task, delete_periodic_task, update_periodic_task
...
class HabitRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    """Generic-класс для просмотра, обновления и удаления одной привычки"""
...
class MyHabitListAPIView(generics.ListAPIView):
    """Generic-класс для вывода списка привычек пользователя"""
